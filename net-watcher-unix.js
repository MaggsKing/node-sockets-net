...
const
    ...
    relace the server with .listen with     .....
server.listen('/tmp/watcher.sock', function(){
      console.log('Listening for subsrcibers...');
    });

faster to use stuff on your own computer than on another server... already there. 

creating socket servers... telephone line... nc command.. to send messages to the client.
